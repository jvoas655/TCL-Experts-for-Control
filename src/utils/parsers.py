...
CatEmbExtractorParser.add_argument("--batch_size", "-b", default = [64, 64, 64, 64, 32], nargs='+', help = "Number of samples per batch")
...
AETrainingParser.add_argument("--max_depth", "-md", default = 1, help = "Max Depth of the autoencoder (will create a encoder for output size [1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1] respectively")
...
AETrainingParser.add_argument("--target_category", "-tc", default = 'raw_cat_embeddings_ind_t5_large', help = "Which set of categories to train for")
AETrainingParser.add_argument("--exp_name", "-en", default = "ind_t5_large_512_ae", help = "Experiment name to use for logging and checkpointing")
