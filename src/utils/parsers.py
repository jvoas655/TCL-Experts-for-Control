...
EvaluationParser.add_argument("--exp_name", default = 'baseline_g_2_0_t64_b10', help = "Which set of categories to train for")
...
EvaluationParser.add_argument("--expert_guidance", default = 2.0, help = "")
