...
if __name__ == "__main__":
    ...
    test_dataset = WDMCExpLMDataset(args.path, "test", args.target_category, args.max_token_count, args.batch_size, lim=2500)
    ...
    summary_results = {
        "perplexity": {"primary": [], "contrastive": [], "pos": [], "reference":[]}, 
        "rouge-1-r": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-1-p": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-1-f": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-2-r": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-2-p": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-2-f": {"primary": [], "contrastive": [], "pos": []},
        "rouge-l-r": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-l-p": {"primary": [], "contrastive": [], "pos": []}, 
        "rouge-l-f": {"primary": [], "contrastive": [], "pos": []},
        "bleu-1": {"primary": [], "contrastive": [], "pos": []}, 
        "bleu-2": {"primary": [], "contrastive": [], "pos": []}
    }
    ...
    with open(str(args.log_path / args.exp_name / "results.json"), "w") as fileref:
